...
public class QueryTest {
	...
	/**
	 * Given a matrix of tuples from SystemTestUtil.createRandomHeapFile, create an
	 * identical HeapFile table
	 * 
	 * @param tuples    Tuples to create a HeapFile from
	 * @param columns   Each entry in tuples[] must have "columns ==
	 *                  tuples.get(i).size()"
	 ...
	 * @throws IOException if a temporary file can't be created to hand to HeapFile
	 *                     to open and read its data
	 */
	public static HeapFile createDuplicateHeapFile(List<List<Integer>> tuples, int columns, String colPrefix)
			throws IOException {
	...
	public void queryTest() throws IOException {
		...
		// This Parser implementation currently just dumps to stdout, so checking that
	...
	/*
	 * Build a large series of tables; then run the command-line query code and
	 * execute a query.
	 * The number of tables is large enough that the query will only succeed within
	 * the
	 * specified time if a join method faster than nested-loops join is available.
	 * The tables are also too big for a query to be successful if its query plan
	 * isn't reasonably efficient,
	 * and there are too many tables for a brute-force search of all possible query
	 * plans.
	 */
	// Not required for Lab 4
	/*
	 * @Test(timeout=60000) public void hashJoinTest() throws IOException,
	 * DbException, TransactionAbortedException {
	 * final int IO_COST = 103;
	 * 
	 * Map<String, TableStats> stats = new HashMap<String,TableStats>();
	 * 
	 * List<List<Integer>> smallHeapFileTuples = new
	 * ArrayList<ArrayList<Integer>>();
	 * HeapFile smallHeapFileA = SystemTestUtil.createRandomHeapFile(2, 100,
	 * Integer.MAX_VALUE, null, smallHeapFileTuples, "c");
	 * HeapFile smallHeapFileB = createDuplicateHeapFile(smallHeapFileTuples, 2,
	 * "c");
	 * HeapFile smallHeapFileC = createDuplicateHeapFile(smallHeapFileTuples, 2,
	 * "c");
	 * HeapFile smallHeapFileD = createDuplicateHeapFile(smallHeapFileTuples, 2,
	 * "c");
	 * HeapFile smallHeapFileE = createDuplicateHeapFile(smallHeapFileTuples, 2,
	 * "c");
	 * HeapFile smallHeapFileF = createDuplicateHeapFile(smallHeapFileTuples, 2,
	 * "c");
	 * HeapFile smallHeapFileG = createDuplicateHeapFile(smallHeapFileTuples, 2,
	 * "c");
	 * HeapFile smallHeapFileH = createDuplicateHeapFile(smallHeapFileTuples, 2,
	 * "c");
	 * HeapFile smallHeapFileI = createDuplicateHeapFile(smallHeapFileTuples, 2,
	 * "c");
	 * HeapFile smallHeapFileJ = createDuplicateHeapFile(smallHeapFileTuples, 2,
	 * "c");
	 * HeapFile smallHeapFileK = createDuplicateHeapFile(smallHeapFileTuples, 2,
	 * "c");
	 * HeapFile smallHeapFileL = createDuplicateHeapFile(smallHeapFileTuples, 2,
	 * "c");
	 * HeapFile smallHeapFileM = createDuplicateHeapFile(smallHeapFileTuples, 2,
	 * "c");
	 * HeapFile smallHeapFileN = createDuplicateHeapFile(smallHeapFileTuples, 2,
	 * "c");
	 * 
	 ...
	 * // even though the worst case takes a very long time.
	 * Parser.
	 * processNextStatement("SELECT COUNT(a.c0) FROM bigTable, a, b, c, d, e, f, g, h, i, j, k, l, m, n WHERE bigTable.c0 = n.c0 AND a.c1 = b.c1 AND b.c0 = c.c0 AND c.c1 = d.c1 AND d.c0 = e.c0 AND e.c1 = f.c1 AND f.c0 = g.c0 AND g.c1 = h.c1 AND h.c0 = i.c0 AND i.c1 = j.c1 AND j.c0 = k.c0 AND k.c1 = l.c1 AND l.c0 = m.c0 AND m.c1 = n.c1;"
	 * );
	 * Parser.
	 * processNextStatement("SELECT COUNT(a.c0) FROM bigTable, a, b, c, d, e, f, g, h, i, j, k, l, m, n WHERE a.c1 = b.c1 AND b.c0 = c.c0 AND c.c1 = d.c1 AND d.c0 = e.c0 AND e.c1 = f.c1 AND f.c0 = g.c0 AND g.c1 = h.c1 AND h.c0 = i.c0 AND i.c1 = j.c1 AND j.c0 = k.c0 AND k.c1 = l.c1 AND l.c0 = m.c0 AND m.c1 = n.c1 AND bigTable.c0 = n.c0;"
	 * );
	 * Parser.
	 * processNextStatement("SELECT COUNT(a.c0) FROM bigTable, a, b, c, d, e, f, g, h, i, j, k, l, m, n WHERE k.c1 = l.c1 AND a.c1 = b.c1 AND f.c0 = g.c0 AND bigTable.c0 = n.c0 AND d.c0 = e.c0 AND c.c1 = d.c1 AND e.c1 = f.c1 AND i.c1 = j.c1 AND b.c0 = c.c0 AND g.c1 = h.c1 AND h.c0 = i.c0 AND j.c0 = k.c0 AND m.c1 = n.c1 AND l.c0 = m.c0;"
	 * );
	 * }
	 */
}
